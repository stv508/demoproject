...
$request = mysqli_query($connect, "SELECT `s_no`,`status` FROM `emp_leaves` WHERE `status` = 0 ");
$request_rows = mysqli_num_rows($request);
?>
    ...
    <div class="content-wrapper">
        <div class="row">
            <div class="col-sm-12 mb-4 mb-xl-0">
                ...
                <p class="font-weight-normal mb-2 text-muted">Feb, 2022</p>
            </div>
        </div>
        <div class="row mt-3">
