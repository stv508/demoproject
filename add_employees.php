              ...
              <div class="row">
                ...
                <div class="col-md-10">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                      <input type="text" class="form-control" placeholder="Enter Aadhar Number" name="aadhar" id="aadhar" maxlength="12" minlength="12" required />
                    </div>
                  </div>
                </div>
                <div class="col-md-10">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                      <input type="text" class="form-control" placeholder="Enter PAN Number" name="pan" id="pan" maxlength="10" minlength="10" required />
                    </div>
                  </div>
                </div>
                <div class="col-md-10">
