                  ...
                  <tbody>
                    ...
                    while ($leave_app_fetch = mysqli_fetch_assoc($leave_app)) {
                      echo "<tr>
                              ...
                              <td><center><button id='appr-".($count-1)."' value='".$leave_app_fetch['s_no']."' data-toggle='modal' data-target='#Approvel' type='button'class='btn btn-success btn-rounded btn-icon'><i class='icon-check'></i></button></center></td>
                              <td><center><button id='den-".($count-1)."' value='".$leave_app_fetch['s_no']."' data-toggle='modal' data-target='#deny' type='button' class='btn btn-danger btn-rounded btn-icon'><i class='icon-cross'></i></button></center></td>
                            </tr>";
                      $count = $count + 1;
                    }
      ...
      <div class="modal fade" id="deny" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <p>Do You Really Want To Deny</p>
            </div>
            <div class="modal-footer">
              <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
